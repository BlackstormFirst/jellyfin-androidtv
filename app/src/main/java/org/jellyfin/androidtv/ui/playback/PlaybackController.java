...
public class PlaybackController implements PlaybackControllerNotifiable {
    ...
    public Integer getBestSubtitleIndex(MediaSourceInfo info) {
        //if ( mCurrentOptions.getAudioStreamIndex() == null ) {
        //    Timber.i("Best subtitle found on server for default");
        //    return info.getDefaultSubtitleStreamIndex();
        //}
        ...
        if (lastSubtitleLanguage != null) {
            if (lastSubtitleLanguage.isEmpty()) {
                ...
                if ((allSubtitleStreams != null) && (lastSubtitleCodec != null)) {
                    // if audio languages different get index from server
                    //if ( currentAudioStreamIsoCode != null && !currentAudioStreamIsoCode.equals(lastAudioLanguageIsoCode) ){
                    //    Timber.d("Best subtitle found on server");
